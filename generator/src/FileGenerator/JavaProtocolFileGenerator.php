...
final class JavaProtocolFileGenerator extends AbstractPhpFileStructureGenerator
{
    ...
    public function createClassFromContent(string $content): ClassLike
    {
        ...
        $versionToProtocolMap = array_reverse($this->formatVersionToProtocolMap(
            $this->unifyValuesByProtocol($parser->parseJavaEditionTable())
        ));
